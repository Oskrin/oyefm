dcapp.controller('configuracionController', ['$scope', 'fileUpload', function ($scope, $route, $location, fileUpload) {
	...
	jQuery(function($) {	
	    ...
	    function session_datos() {
	        $.ajax({
	            type: "POST",
	            url: "data/configuracion/app.php",
...
dcapp.directive('fileModel', ['$parse', function ($parse) {
    return {
        restrict: 'A',
...
dcapp.service('fileUpload', ['$http', function($http) {
...
// dcapp.service('upload', ["$http", "$q", function ($http, $q) {
...
// dcapp.directive('uploaderModel', ["$parse", function ($parse) {
// 	return {
// 		restrict: 'A',
