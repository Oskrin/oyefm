...
angular.module('scotchApp').controller('porcentajeController', function ($scope) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/porcentaje/xml_porcentaje.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/porcentaje/xml_porcentaje.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
	        height: 415,
	        colNames:['','ID','DESCRIPCIÓN','PORCENTAJE','OBSERVACIONES','FECHA CREACIÓN'],
	        colModel:[
	            ...
	            {name:'porcentaje',index:'porcentaje',width:200, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}}, 
	        ...
	        editurl: "data/porcentaje/app.php",
	        // caption: "LISTA TIPO CONTRATOS"
	    });
