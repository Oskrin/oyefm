angular.module('scotchApp').controller('tipo_multasController', function ($scope) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/tipo_multas/xml_tipo_multas.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/tipo_multas/xml_tipo_multas.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
	        colNames:['','ID','DESCRIPCIÓN','MONTO MULTA','OBSERVACIONES','FECHA CREACIÓN'],
	        colModel:[
	            ...
	            {name:'descripcion',index:'descripcion',width:'300px', editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
	            {name:'monto_multa',index:'monto_multa',width:'', editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_multas/app.php",
