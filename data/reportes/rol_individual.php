<?php
    ...
    function Header() {
        ...
        $this->Text(109, 50, utf8_decode(strftime("%A, %d de %B de %Y", $mydate)),1, 'L');
        $this->SetFont('Arial','B',9);
    ...
    $pdf->Output('../rol_pagos/roles_digitales/OSCAR SILVIO TROYA CARBAJAL/'. $fecha.'.pdf', 'F'); 
    $pdf->Output();
?>