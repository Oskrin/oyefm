...
function Header() {
    ...
    $this->Cell(80);
    // Título
    $this->Cell(65,50,'ROL DE PAGOS MAYO',0,0,'C');
    $this->SetLineWidth(0.3);
    $this->SetFillColor(255,255,255);
    $this->RoundedRect(20, 31, 50, 8, 1.5, 'DF');
    
    $this->SetTextColor(255,87,51);
    $this->Text(22, 37, utf8_decode('RDP0417CR60105 '),1,0, 'L',0);/////cargos
    ...
    $this->Text(39, 50, maxCaracter(utf8_decode('RUILOVA IDROBO CARLOS A'),23),1,0, 'L',0);/////nombres completos
    $this->SetFont('Arial','B',9);
    $this->Text(18, 56, 'CARGO:',1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(32, 56, utf8_decode('LOCUTOR@'),1,0, 'L',0);/////cargos
    $this->SetFont('Arial','B',9);
    $this->Text(18, 62, 'SUELDO:',1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(34, 62, utf8_decode('375.00'),1, 'L');

    $this->SetFont('Arial','B',9);
    $this->Text(100, 50, 'PAGO:',1, 'L');
    $this->SetFont('Arial','',9);
    $mydate = strtotime('2017-05-05');
    $this->Text(111, 50, utf8_decode(strftime("%d / %B / %Y", $mydate)),1, 'L');
    $this->SetFont('Arial','B',9);
    $this->Text(100, 56, 'HORA:',1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(110, 56, '11:00:00',1, 'L');
    $this->SetFont('Arial','B',9);
    $this->Text(100, 62, utf8_decode('DÍAS NO LAB:'),1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(122, 62, '0',1, 'L');

    $this->SetFont('Arial','B',9);
    $this->Text(145, 50, 'HORAS DIARIAS:',1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(174, 50, '08:00',1, 'L');
    $this->SetFont('Arial','B',9);
    $this->Text(145, 56, utf8_decode('DÍAS LAB:'),1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(163, 56, '30',1, 'L');
    $this->SetFont('Arial','B',9);
    $this->Text(145, 62, utf8_decode('HORAS EXTRAS:'),1, 'L');
    $this->SetFont('Arial','',9);
    $this->Text(174, 62, '0',1, 'L');
    //Salto de línea
    ...
    $this->SetY(73);
    $this->SetX(75);
    $this->multiCell(22, 6, '$ 375.00',0,'R');

    $this->Text(18, 82, 'Horas Extras', 1, 'L');
    $this->SetY(78);
    $this->SetX(75);
    $this->multiCell(22, 6, '$ 0.00',0,'R');
    ...
    $this->SetY(93);
    $this->SetX(168);
    $this->multiCell(22, 6, '$ 10.00',0,'R');

    $this->Text(111, 102, utf8_decode('Permisos'), 1, 'L');
    $this->SetY(98);
    $this->SetX(168);
    $this->multiCell(22, 6, '$ 4.69',0,'R');
    ...
    $this->SetY(108);
    $this->SetX(168);
    $this->multiCell(22, 6, '$ 20.00',0,'R');

    $this->SetFont('Arial','B',9);
    $this->Text(111, 117, utf8_decode('TOTAL DESCUENTOS'), 1, 'L');
    $this->SetY(112);
    $this->SetX(168);
    $this->multiCell(22, 6, '$ 65.44',0,'R');
    ...
    $this->Text(110, 126, utf8_decode('$ 309.56'), 1, 'L');
    ...
    $this->Text(163, 143, utf8_decode('C.I: 1002804969'), 1, 'L');
