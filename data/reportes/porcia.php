<?php
    ...
    $pdf->SetY(69);
    $pdf->SetX(10);
    $pdf->multiCell(185, 3, utf8_decode($detalle),0);
    ...
    while ($row = $class->fetch_array($resp)) {
        ...
        $pdf->SetY($posiciony);
        $pdf->SetX(135);
        $pdf->multiCell(20,6, utf8_decode($cantidad),1);
        ...
        if ($estado == '1') {
            ...
            $pdf->SetX(178);
            $pdf->SetTextColor(25, 25, 25);
            $pdf->SetFillColor(122,253,2);
            $pdf->multiCell(23, 6, utf8_decode($valor),1,'', 1, 0, '', '', true, 0, false, true, 0);   
        }
    ...
    $pdf->SetY($posiciony);
    $pdf->SetX(135);
    $pdf->multiCell(20,6, utf8_decode(''),1);
    ...
    $pdf->SetY($posiciony);
    $pdf->SetX(178);
    $pdf->multiCell(23,6, truncateFloat($total_valor,2),1);
