angular.module('scotchApp').controller('perfilesController', function ($scope, $route) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/perfiles/xml_perfiles.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: "data/perfiles/xml_perfiles.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
			height: 415,
			colNames:['','ID','PERFIL',''],
			colModel:[
				...
				{name:'nombre_cargo',index:'nombre_cargo',width:150, editable:true, editoptions:{size:"20", maxlength:"30"}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}}, 
	            {name:'fecha_creacion',index:'fecha_creacion', width:150,editable: true, search:false, hidden:false, editoptions:{size:"20", maxlength:"30", readonly: 'readonly'}}
			],
	        rownumbers: true,
	        rowNum:10,
	        rowList:[10,20,30],
