...
angular.module('scotchApp').controller('bancosController', function ($scope) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/bancos/xml_bancos.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/bancos/xml_bancos.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
	        height: 415,
