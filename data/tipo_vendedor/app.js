...
angular.module('scotchApp').controller('tipo_vendedoresController', function ($scope) {
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/tipo_vendedor/xml_vendedores.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
		...
		$('#btn_guardar').click(function() {
			...
			if (respuesta == true) {
				...
				$.ajax({
			        url: "data/tipo_vendedor/app.php",
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/tipo_vendedor/xml_vendedores.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
	        colNames:['','ID','NOMBRE','OBSERVACIONES','FECHA CREACIÓN'],
	        colModel:[
	            ...
	            {name:'nombre',index:'nombre',width:'300px', editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}}, 
	            {name:'observaciones', index:'observaciones', frozen: true, editable:true, search:false, edittype:"textarea", editrules: {required: false}, width: ''},
	        ...
	        editurl: "data/tipo_vendedor/app.php",
	        // caption: "LISTA TIPO VENDEDORES"
	    });
