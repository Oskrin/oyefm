...
/**
 * Common StringElement functions
 */
class StringElement
{
    /**
     ...
     *
     * @param StringElement $value Value to unescape
     ...
     *
     * @param StringElement $value Value to escape
     * @return StringElement
     */
    ...
    /**
     * Check if a StringElement contains UTF-8 data
     *
     ...
     *
     * @param StringElement $text UTF8 text
     * @return StringElement Unicode text
     * @since 0.11.0
     */
