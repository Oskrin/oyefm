angular.module('scotchApp').controller('areasController', function ($scope) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function() {
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/areas/xml_areas.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
			        ...
			        success: function (data) {
			        	...
			        	if(data == '1') {
				    		...
				    		if(data == '3') {
				        		$.gritter.add({
									title: 'Mensaje',
									text: 'Error... El Registro ya fue Agregado <i class="ace-icon fa fa-spinner fa-spin green bigger-125"></i>',
									time: 1000				
								});
								$("#nombre").val('');
					    	}
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: "data/areas/xml_areas.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
			colNames:['','ID','NOMBRE SUB EMPRESA','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2'){
                	...
                	if(retorno == '3') {
                		$("#nombre").val("");
	                	return [false,"Error.. El area ya fue agregada"];
	                }
                }
                return [true,'',retorno];
            },
