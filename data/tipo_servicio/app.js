angular.module('scotchApp').controller('tipo_servicioController', function ($scope) {
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/tipo_servicio/xml_servicio.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
		...
		$('#btn_guardar').click(function() {
			...
			if (respuesta == true) {
				...
				$.ajax({
			        url: "data/tipo_servicio/app.php",
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/tipo_servicio/xml_servicio.php?campo="+campo,
	        autoencode: true,
	        datatype: "xml",
	        ...
	        editurl: "data/tipo_servicio/app.php",
