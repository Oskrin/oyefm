...
angular.module('scotchApp').controller('tipo_contratoController', function ($scope) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/tipo_contrato/xml_tipo_contrato.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
		...
		$('#btn_guardar').click(function() {
			...
			if (respuesta == true) {
				...
				$.ajax({
			        url: "data/tipo_contrato/app.php",
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: "data/tipo_contrato/xml_tipo_contrato.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
	        height: 415,
	        ...
	        colModel:[
	            ...
	            {name:'nombre_tipo',index:'nombre_tipo',width:150, editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}}, 
	        ...
	        editurl: "data/tipo_contrato/app.php",
