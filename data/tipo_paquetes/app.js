angular.module('scotchApp').controller('tipo_paquetesController', function ($scope, $route) {
	...
	jQuery(function($) {
		...
		$("#buscador").keyup(function(){
			...
			jQuery("#grid-table").jqGrid('setGridParam',{url:"data/tipo_paquetes/xml_tipo_paquetes.php?campo="+campo,page:1}).trigger("reloadGrid");
		});
		// fin
		...
		$('#btn_guardar').click(function() {
			...
			if (respuesta == true) {
				...
				$.ajax({
			        url: "data/tipo_paquetes/app.php",
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: "data/tipo_paquetes/xml_tipo_paquetes.php?campo="+campo,
	        autoencode: false,
	        datatype: "xml",
			...
			colModel:[
				...
				{name:'nombre_paquete',index:'nombre_paquete',width:'300px', editable:true, editoptions:{size:"20",maxlength:"30"}, editrules: {required: true}, editoptions:{dataInit: function(elem){$(elem).bind("keyup", function(e) {this.value = this.value.toUpperCase(e)})}}}, 
	        ...
	        editurl: "data/tipo_paquetes/app.php",
	        // caption: "LISTA TIPO PAQUETES"
	    });
