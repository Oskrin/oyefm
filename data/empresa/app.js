	...
	jQuery(function($) {
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        colNames: ['ID','IDENTIFICACIÓN','PROPIETARIO','NOMBRE EMPRESA','SLOGAN','TELÉFONO','CELULAR','CIUDAD','DIRECCIÓN','CORREO','FAX','SITIO WEB','AUTORIZACIÓN SRI','FACTURA PREIMPRESA','NUM. ITEMS','OBSERVACIONES'],
		        colModel:[      
		            ...
		            {name:'autorizacion_sri',index:'autorizacion_sri',frozen : true, hidden: false, align:'left',search:false,width: ''},
		            {name:'inicio_fac_preimpresa',index:'inicio_fac_preimpresa',frozen : true, hidden: false, align:'left',search:false,width: ''},
		            {name:'item_factura',index:'item_factura',frozen : true, hidden: false, align:'left',search:false,width: ''},
		        ...
		        ondblClickRow: function(rowid) {     	            	            
	            	...
	            	$('#autorizacion_sri').val(ret.autorizacion_sri);
	            	$('#inicio_fac_preimpresa').val(ret.inicio_fac_preimpresa);
	            	$('#item_factura').val(ret.item_factura);
