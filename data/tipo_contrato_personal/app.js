...
angular.module('scotchApp').controller('tipo_contrato_personalController', function ($scope) {
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({	       
	        url: 'data/tipo_contrato_personal/xml_tipo_contrato_personal.php',
	        autoencode: false,
	        datatype: "xml",
	        height: 330,
	        ...
	        editurl: "data/tipo_contrato_personal/app.php",
	        caption: "LISTA TIPO CONTRATOS PERSONAL"
	    });
