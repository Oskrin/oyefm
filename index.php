      ...
      <md-toolbar layout="row" md-theme="teal" md-theme-watch="true">
        ...
        <div flex>
          <div class="md-toolbar-tools toolbar-center">
            <md-button class="md-icon-button" aria-label="Settings" ng-click="modal_footer()">
            ...
            <span flex></span>
            <a href="#!/Nb/Inicio" class="btn btn--l btn--white btn--icon" lx-ripple>
                <md-icon>home</md-icon>
            </a>

            <a href="#!/Nb/App" class="btn btn--l btn--white btn--icon" lx-ripple>
        ...
        <div layout="row" flex app-view-segment="1" class="view-next"></div>
                        ...
                        <li class="transparent">
                            ...
                            <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                <li class="dropdown-header">
                                    <i class="ace-icon fa fa-envelope-o"></i> Mensajes
                                </li>
        ...
        <div class="main-container" id="main-container">
                        ...
                        <ul class="nav nav-list">
                            <li class="hover">
                                ...
                                <ul class="submenu">
                                    <li class="hover">
                                        <a href="#!/presentacion">
                                            <i class="menu-icon fa fa-caret-right"></i> Presentación
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/quienes_somos">
                                            <i class="menu-icon fa fa-caret-right"></i> ¿Quienes Somos?
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/mision_vision">
                                            <i class="menu-icon fa fa-caret-right"></i> Misión / Visión
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/politicas">
                                            <i class="menu-icon fa fa-caret-right"></i> Políticas
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/reglamento">
                                            <i class="menu-icon fa fa-caret-right"></i> Reglamento Interno
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/funciones">
                                            <i class="menu-icon fa fa-caret-right"></i> Funciones
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="#!/precios">
                                            <i class="menu-icon fa fa-caret-right"></i> Precios
                                        </a>
                                ...
                                <ul class="submenu">
                                    <li class="hover">
                                        <a href="#!/contratos_selectivos">
                                            <i class="menu-icon fa fa-caret-right"></i> Contratos
                                        </a>
                                    </li>

                                    <li class="hover">
                                        <a href="#!/cuentas_cobrar">
                                            <i class="menu-icon fa fa-caret-right"></i> Cuentas Cobrar
                                        </a>
                                    </li>

                                    <li class="hover">
                                        <a href="#!/facturas">
                                            <i class="menu-icon fa fa-caret-right"></i> Facturación
                                        </a>
                                    </li>
                                ...
                                <ul class="submenu">
                                    <li class="hover">
                                        <a href="#!/tipo_programa">
                                            <i class="menu-icon fa fa-caret-right"></i> Tipo Programa
                                        </a>
                                    ...
                                    <li class="hover">
                                        <a href="">
                                            <i class="menu-icon fa fa-caret-right"></i> Programas
                                            <b class="arrow fa fa-angle-down"></b>
                                        </a>
                                        ...
                                        <ul class="submenu">
                                            <li class="hover">
                                                <a href="#!/ficha_programas">
                                                    <i class="menu-icon fa fa-caret-right"></i> Nueva Ficha
                                                </a>
                                            ...
                                            <li class="hover">
                                                <a href="#!/fotos_programas">
                                                    <i class="menu-icon fa fa-caret-right"></i> listado
                                                </a>
                                    ...
                                    <li class="hover">
                                        <a href="">
                                            <i class="menu-icon fa fa-caret-right"></i> Invitados
                                            <b class="arrow fa fa-angle-down"></b>
                                        </a>
            ...
            <div class="footer">
              ...
              <span class="green bolder">OyeFm 93.1</span> Applicación &copy; 2016-2017
                        </span>
                    </div>
                </div>
            </div>
